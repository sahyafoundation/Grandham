...
![Grandham Banner](https://img.shields.io/badge/Language-Malayalam-green) ![License](https://img.shields.io/badge/License-GPL-blue) ![Wikidata](https://img.shields.io/badge/Data-Wikidata-orange)
...
- [Wikidata](https://www.wikidata.org) - For providing structured open data
- [Wikimedia Commons](https://commons.wikimedia.org) - For hosting media files
...
- Project Website: [grandham.in](https://grandham.in)
- Wikidata Project: [Wikidata:WikiProject Kerala](https://w.wiki/CvD)
- Issues: [GitHub Issues](https://github.com/sahyafoundation/Grandham/issues)

## 🔗 Related Resources

- [Wikidata SPARQL Query Service](https://query.wikidata.org)
- [Malayalam Wikisource](https://ml.wikisource.org)
- [Wiki Project Kerala](https://w.wiki/CvD)
- [Wikimedians of Kerala User Group](https://w.wiki/t9)
- [Sahya Digital Conservation Foundation](https://sahya.org.in)
